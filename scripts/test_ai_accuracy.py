    ...
    try:
        ...
        gpt_response = openai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are an expert turfgrass agronomist. Answer questions based ONLY on the provided context. Be specific with rates, timing, and products. Always cite which product/source you're referencing. If context lacks info, say 'Information not found in database'.",
                },
                {
                    "role": "user",
        ...
        return {"question": question, "answer": f"ERROR: {e}", "sources": [], "relevance_score": 0}
