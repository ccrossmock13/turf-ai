    ...
    # -----------------------------------------------------------------------
    {
        ...
        'response': {
            'answer': (
                ...
                "- Cross-references a curated knowledge base of product labels, university research, NTEP trial data, disease/pest/weed guides, and spray programs\n"
                "- Provides **reference photos** for diseases, weeds, and pests so you can visually confirm field identifications\n"
                "- Accepts **in-chat photo uploads** — snap a photo of a problem area and get a diagnosis with treatment recommendations\n"
                "- Integrates **real-time weather data** to contextualize application timing and disease pressure\n"
                ...
                "**How It Works:**\n"
                "1. Your question is analyzed and classified by topic and intent\n"
                "2. Our knowledge base of research vectors — covering 28 diseases, 56 weeds, 33 pests, nematodes, abiotic disorders, cultural practices, and hundreds of product labels — is searched\n"
                "3. Results are scored, hybrid-reranked (BM25 + semantic), and enriched with structured product data\n"
                "4. An AI generates the answer using only verified source material\n"
                "5. The answer is grounding-checked, hallucination-filtered, and validated against product labels and FRAC codes\n"
