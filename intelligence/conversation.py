...
from db import CONVERSATIONS_DB, FEEDBACK_DB, get_db
...
class ConversationIntelligence:
    ...
    def analyze_conversation(conversation_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            for i, msg in enumerate(user_messages):
                ...
                if any(
                    w in content
                    for w in ["wrong", "incorrect", "no that", "that's not", "not what i", "try again", "not helpful"]
                ):
            ...
            with get_db(FEEDBACK_DB) as feedback_conn:
                ...
                """,
                    (
                        ...
                        resolution,
                        frustration_score,
                        json.dumps(frustration_signals),
                        drift_score,
    ...
    def batch_analyze_recent(days: int = 7):
        ...
        try:
            ...
            if analyzed > 0:
                log_event("conversation_intelligence", "batch_analyzed", json.dumps({"count": analyzed}))
        except Exception as e:
    ...
    def compute_system_health() -> Dict:
        ...
        try:
            ...
            if lats:
                ...
                p95 = 0
                lat_score = 75
            components["latency"] = {"score": round(lat_score, 1), "weight": 0.15, "detail": f"p95: {p95:.0f}ms"}
            ...
            if esc and esc["total"] > 0:
                ...
                resolution_rate = 1.0
                esc_score = 85
            components["escalation_resolution"] = {
                "score": round(esc_score, 1),
                "weight": 0.10,
    ...
    def get_kpi_trends(period: str = "30d") -> Dict:
        ...
        try:
            ...
            return {
                ...
                "daily_satisfaction": [
                    {"day": r["day"], "rate": round(r["correct"] / max(r["total"], 1), 3), "total_rated": r["total"]}
                    for r in daily_sat
                ],
            }
        except Exception as e:
