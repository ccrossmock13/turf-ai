...
class KnowledgeGapAnalyzer:
    ...
    def detect_gaps() -> List[Dict]:
        ...
        try:
            ...
            for gap in gaps:
                ...
                """,
                    (
                        ...
                        gap["gap_type"],
                        gap["severity"],
                        gap.get("avg_confidence"),
                        gap["question_count"],
                        json.dumps(gap["sample_questions"]),
            ...
            if gaps:
                log_event("knowledge_gaps", "gaps_detected", json.dumps({"count": len(gaps)}), "info")
                    ...
                    matrix.append(
                        {
                            ...
                            "quality_score": round(
                                ((stats["avg_conf"] or 0) / 100 + (stats["positive"] or 0) / stats["count"]) / 2, 3
                            ),
                        }
                    )
