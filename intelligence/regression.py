...
class RegressionDetector:
    ...
    def add_regression_test(
        question: str, expected_answer: str, category: str = None, criteria: str = None, priority: int = 1
    ) -> int:
    ...
    def run_regression_suite(ask_function=None, trigger: str = "scheduled") -> Dict:
        ...
        for test in tests:
            try:
                ...
                # Compute drift score
                drift = _compute_drift_score(test["expected_answer"], actual_answer, test["criteria"])
