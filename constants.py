...
PGRS = ["primo", "trimmit", "cutless", "anuew", "embark", "proxy", "appear", "legacy", "musketeer", "governor"]

# Biological/microbial products
BIOLOGICALS = ["rhapsody", "cease", "civitas", "companion", "stressgard", "nortica", "velondis", "miresol", "biodude"]
...
DEFAULT_SOURCES = [
    {"number": 1, "name": "USGA Green Section", "url": "https://www.usga.org/course-care.html", "type": "reference"},
    {"number": 2, "name": "GCSAA Resources", "url": "https://www.gcsaa.org/", "type": "reference"},
    {"number": 3, "name": "Purdue Turfgrass Science", "url": "https://turf.purdue.edu/", "type": "reference"},
    {"number": 4, "name": "Rutgers Turfgrass", "url": "https://njaes.rutgers.edu/turf/", "type": "reference"},
]
...
SOURCE_CREDIBILITY_LOW = ["catalog", "brochure", "info sheet", "general", "small pack"]
