...
def delete_report(report_id, user_id):
    ...
    with get_db() as conn:
        ...
        conn.execute("DELETE FROM scouting_photos WHERE report_id = ?", (report_id,))
        cursor = conn.execute(
...
def get_reports(user_id, start_date=None, end_date=None, area=None, issue_type=None, status=None):
    """
...
def add_photo(report_id, user_id, photo_data, photo_type="initial", caption=""):
    ...
    with get_db() as conn:
        ...
        row = conn.execute("SELECT * FROM scouting_photos WHERE id = ?", (photo_id,)).fetchone()
...
def save_scouting_template(user_id, data):
    ...
    with get_db() as conn:
        ...
        row = conn.execute("SELECT * FROM scouting_templates WHERE id = ?", (template_id,)).fetchone()
    ...
    return [
        {
            ...
            "checklist_json": [
                ...
                {"item": "Soil moisture level", "type": "select", "options": ["dry", "adequate", "wet", "saturated"]},
                {"item": "Dew presence", "type": "checkbox", "options": ["heavy", "light", "none"]},
                {"item": "Mowing quality", "type": "rating", "scale": "1-10"},
                {"item": "Ball mark damage", "type": "select", "options": ["none", "light", "moderate", "heavy"]},
            ...
            "checklist_json": [
                {
                    ...
                    "items": [
                        {
                            "item": "Disease presence",
                            "type": "checkbox",
                            "options": ["none", "dollar spot", "brown patch", "anthracnose", "pythium", "other"],
                        },
                        {
                            "item": "Pest activity",
                            "type": "checkbox",
                            "options": ["none", "grubs", "cutworms", "armyworms", "mites", "other"],
                        },
                        {
                            "item": "Weed pressure",
                            "type": "checkbox",
                            "options": ["none", "poa annua", "clover", "crabgrass", "goosegrass", "other"],
                        },
                ...
                },
                {
                    ...
                    "items": [
                        ...
                        },
                        {
                            "item": "Weed pressure",
                            "type": "checkbox",
                            "options": ["none", "crabgrass", "goosegrass", "dandelion", "clover", "other"],
                        },
                        {"item": "Overall turf quality", "type": "rating", "scale": "1-10"},
                    ],
                },
                {
                    "section": "Tees",
                    "items": [
                        {"item": "Disease presence", "type": "checkbox", "options": ["none", "other"]},
                        {"item": "Pest activity", "type": "checkbox", "options": ["none", "other"]},
                        {"item": "Weed pressure", "type": "checkbox", "options": ["none", "other"]},
                        {"item": "Overall turf quality", "type": "rating", "scale": "1-10"},
                        {"item": "Divot recovery", "type": "select", "options": ["excellent", "good", "fair", "poor"]},
                    ],
                },
                {
                    "section": "Rough",
                ...
                },
                {
                    "section": "Bunkers",
                    "items": [
                        {"item": "Sand depth adequate", "type": "checkbox", "options": ["yes", "no"]},
                        {
                            "item": "Edge maintenance",
                            "type": "select",
                            "options": ["excellent", "good", "fair", "poor"],
                        },
                        {"item": "Drainage issues", "type": "checkbox", "options": ["none", "minor", "major"]},
                        {
                            "item": "Contamination (weeds, debris)",
                            "type": "select",
        ...
        },
        {
            ...
            "checklist_json": [
                ...
                {
                    "item": "Phytotoxicity observed",
                    "type": "select",
                    "options": ["none", "slight tip burn", "moderate discoloration", "severe damage"],
                },
                {"item": "Coverage uniformity", "type": "select", "options": ["excellent", "good", "fair", "poor"]},
                {"item": "Re-application needed", "type": "checkbox", "options": ["yes", "no"]},
            ...
            "checklist_json": [
                {
                    ...
                    "items": [
                        {"item": "Green speed (stimpmeter)", "type": "number", "unit": "feet"},
                        {"item": "Speed consistency across holes", "type": "rating", "scale": "1-10"},
                        {"item": "Surface uniformity", "type": "rating", "scale": "1-10"},
                        {
                            "item": "Pin placement conditions",
                            "type": "select",
                            "options": ["excellent", "good", "fair", "poor"],
                        },
                        {"item": "Disease or stress visible", "type": "checkbox", "options": ["yes", "no"]},
                    ],
                },
                {
                    "section": "Fairways",
                    "items": [
                        ...
                        {"item": "Lie consistency", "type": "select", "options": ["excellent", "good", "fair", "poor"]},
                        {
                            "item": "Divot fill level",
                            "type": "select",
                ...
                },
                {
                    ...
                    "items": [
                        ...
                        {"item": "Rake availability", "type": "checkbox", "options": ["all present", "some missing"]},
                        {"item": "Edge definition", "type": "select", "options": ["sharp", "acceptable", "needs work"]},
                    ],
                },
                {
                    "section": "Hazard Areas",
                    "items": [
                        {"item": "Penalty area markings correct", "type": "checkbox", "options": ["yes", "no"]},
                        {"item": "OB stakes visible", "type": "checkbox", "options": ["yes", "no"]},
                        {
                            "item": "Cart path conditions",
                            "type": "select",
                            "options": ["excellent", "good", "fair", "poor"],
                        },
                        {"item": "Spectator areas prepared", "type": "checkbox", "options": ["yes", "no"]},
                    ],
                },
                {
                    "section": "General",
                    "items": [
                        {"item": "Overall course presentation", "type": "rating", "scale": "1-10"},
                        {"item": "Signage in place", "type": "checkbox", "options": ["yes", "no"]},
                        {"item": "Practice area ready", "type": "checkbox", "options": ["yes", "no"]},
...
def get_issue_summary(user_id, days=30):
    ...
    with get_db() as conn:
        ...
        total_row = conn.execute(
            "SELECT COUNT(*) as cnt FROM scouting_reports " "WHERE user_id = ? AND scout_date >= ?",
            (user_id, cutoff),
        ).fetchone()
...
def get_treatment_history(user_id, issue_type=None):
    ...
    """
    query = "SELECT * FROM scouting_reports " "WHERE user_id = ? AND treatment_applied IS NOT NULL"
    params = [user_id]
...
def generate_weekly_report(user_id):
    ...
    with get_db() as conn:
        ...
        active = conn.execute(
            "SELECT * FROM scouting_reports " "WHERE user_id = ? AND status != 'resolved' " "ORDER BY severity DESC",
            (user_id,),
        ).fetchall()
