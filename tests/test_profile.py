...
from climate_data import calculate_gdd, get_climate_data, get_current_season
...
class TestContextBuilder:
    ...
    def test_pgr_in_context(self):
        save_profile(USER_ID, {"course_name": "Test", "pgr_program": {"product": "Primo Maxx", "rate": "0.125 oz"}})
    ...
    def test_irrigation_in_context(self):
        save_profile(
            USER_ID, {"course_name": "Test", "irrigation_schedule": {"system_type": "overhead", "run_times": "12 min"}}
        )
...
class TestBackwardCompat:
    def test_old_profile_loads(self):
        ...
        save_profile(
            USER_ID, {"course_name": "Old Course", "city": "Austin", "state": "Texas", "primary_grass": "bermudagrass"}
        )
        p = get_profile(USER_ID)
        assert p["city"] == "Austin"
