...
class TestWorkOrders:
    ...
    def test_update_work_order(self, auth_client):
        ...
        resp = auth_client.put(
            f"/api/crew/work-orders/{order_id}",
            json={
                "title": "Updated title",
                "priority": "urgent",
            },
    ...
    def test_assign_work_order(self, auth_client):
        ...
        resp = auth_client.post(
            f"/api/crew/work-orders/{order_id}/assign",
            json={
    ...
    def test_complete_work_order(self, auth_client):
        ...
        resp = auth_client.post(
            f"/api/crew/work-orders/{order_id}/complete",
            json={
                "actual_hours": 3.5,
            },
        )
