...
ESTABLISHMENT_TIMELINES = {
    "creeping_bentgrass": {
        ...
        "sod": {
            ...
            "notes": "Keep sod moist for first 2 weeks. " "Avoid heavy traffic for 4-6 weeks.",
        },
    },
    "bermudagrass": {
        "seed": {
            ...
            "notes": "Soil temps must be above 65F. " "Seed at 1-2 lbs/1000 sq ft for common types.",
        },
        "sprig": {
            "germination_days": "N/A",
            ...
            "notes": "Plant sprigs 6-12 inches apart. " "Topdress lightly and keep moist. " "Roll after planting.",
        },
        "sod": {
            "germination_days": "N/A",
            ...
            "notes": "Water immediately after installation. " "Avoid heavy use for 3-4 weeks.",
        },
        "plug": {
            "germination_days": "N/A",
            "first_mow_days": "30-45",
            ...
            "notes": "Space plugs 6-12 inches apart. " "Fertilize lightly every 4 weeks during grow-in.",
        },
    },
    "kentucky_bluegrass": {
        "seed": {
        ...
        "sod": {
            ...
            "notes": "Water sod immediately. " "Mow when grass reaches 3-3.5 inches.",
        },
    },
    "perennial_ryegrass": {
        "seed": {
        ...
        "sod": {
            ...
            "best_planting": "Spring or fall",
            "notes": "Roots establish quickly. " "Excellent for quick repairs.",
        },
    },
    "tall_fescue": {
        "seed": {
        ...
        "sod": {
            ...
            "full_establishment_months": "3-6",
            "best_planting": "Spring or fall",
            "notes": "Keep sod moist for first 10 days. " "Mow at 3-4 inches.",
        },
    },
    "zoysiagrass": {
        "seed": {
            ...
            "best_planting": "Late spring to early summer (May-Jun)",
            "notes": "Very slow from seed. Soil temps must be above 70F. " "Seed at 1-2 lbs/1000 sq ft.",
        },
        "sprig": {
            "germination_days": "N/A",
            "first_mow_days": "30-45",
            ...
            "full_establishment_months": "6-12",
            "best_planting": "Late spring to early summer",
            "notes": "Plant sprigs 6 inches apart. " "Topdress and roll after planting.",
        },
        "sod": {
            "germination_days": "N/A",
            "first_mow_days": "14-21",
            ...
            "full_establishment_months": "3-6",
            "best_planting": "Late spring to summer",
            "notes": "Water frequently for first 2 weeks. " "Slow lateral growth initially.",
        },
        "plug": {
            "germination_days": "N/A",
            ...
            "notes": "Space plugs 6 inches apart for faster coverage. " "Patience required -- zoysia is slow to fill.",
        },
    },
    "fine_fescue": {
        "seed": {
            ...
            "full_establishment_months": "4-8",
            "best_planting": "Fall (Sep-Oct)",
            "notes": "Seed at 4-5 lbs/1000 sq ft. " "Excellent shade tolerance. Low fertilizer needs.",
        },
    },
    "seashore_paspalum": {
        "sprig": {
            ...
            "full_establishment_months": "4-8",
            "best_planting": "Late spring to early summer",
            "notes": "Salt tolerant -- ideal for coastal areas. " "Requires warm soil temps above 65F.",
        },
        "sod": {
            "germination_days": "N/A",
            "first_mow_days": "10-14",
            ...
            "full_establishment_months": "3-6",
            "best_planting": "Late spring to summer",
            "notes": "Excellent salt tolerance. " "Can be irrigated with reclaimed water.",
        },
    },
}
...
def _build_cultivar_records():
    ...
    def _add(
        name, species, category, scores, year="2020", region="National", seed_available=1, seeding_rate=None, notes=None
    ):
    ...
    records.append(
        _add(
            ...
            "greens",
            {
                ...
                "drought_tolerance": 5.5,
                "heat_tolerance": 6.8,
                "cold_tolerance": 7.5,
                "shade_tolerance": 5.0,
                "traffic_tolerance": 7.2,
                "establishment_rate": 7.0,
                "mowing_tolerance": 8.5,
            },
            year="2019",
            seeding_rate="1-1.5 lbs/1000 sq ft",
    ...
    records.append(
        _add(
            ...
            "greens",
            {
                ...
                "color_score": 7.8,
                "density_score": 8.4,
                "disease_resistance": 7.5,
                "drought_tolerance": 5.8,
                "heat_tolerance": 7.0,
                "cold_tolerance": 7.2,
                "shade_tolerance": 5.2,
                "traffic_tolerance": 7.5,
                "establishment_rate": 7.2,
                "mowing_tolerance": 8.7,
            },
            year="2020",
            seeding_rate="1-1.5 lbs/1000 sq ft",
            notes="Premium putting green bentgrass. Improved disease resistance " "over previous generation.",
        )
    )
    records.append(
        _add(
            ...
            "greens",
            {
                ...
                "color_score": 8.0,
                "density_score": 8.0,
                "disease_resistance": 7.2,
                "drought_tolerance": 5.6,
                "heat_tolerance": 6.5,
                "cold_tolerance": 7.8,
                "shade_tolerance": 5.5,
                "traffic_tolerance": 7.0,
                "establishment_rate": 6.8,
                "mowing_tolerance": 8.3,
            },
            year="2019",
            seeding_rate="1-1.5 lbs/1000 sq ft",
    ...
    records.append(
        _add(
            ...
            "greens",
            {
                ...
                "color_score": 7.2,
                "density_score": 7.8,
                "disease_resistance": 7.8,
                "drought_tolerance": 5.5,
                "heat_tolerance": 6.5,
                "cold_tolerance": 7.6,
                "shade_tolerance": 5.8,
                "traffic_tolerance": 7.0,
                "establishment_rate": 7.5,
                "mowing_tolerance": 8.0,
            },
            year="2018",
            seeding_rate="1-1.5 lbs/1000 sq ft",
            notes="Good disease resistance package, especially dollar spot. " "Reliable performer across regions.",
        )
    )
    records.append(
        _add(
            ...
            "greens",
            {
                ...
                "color_score": 7.4,
                "density_score": 8.0,
                "disease_resistance": 7.3,
                "drought_tolerance": 5.4,
                "heat_tolerance": 6.7,
                "cold_tolerance": 7.4,
                "shade_tolerance": 5.0,
                "traffic_tolerance": 7.3,
                "establishment_rate": 7.0,
                "mowing_tolerance": 8.2,
            },
            year="2019",
            seeding_rate="1-1.5 lbs/1000 sq ft",
    ...
    records.append(
        _add(
            ...
            "greens",
            {
                ...
                "color_score": 7.6,
                "density_score": 8.1,
                "disease_resistance": 7.1,
                "drought_tolerance": 5.3,
                "heat_tolerance": 6.9,
                "cold_tolerance": 7.3,
                "shade_tolerance": 5.1,
                "traffic_tolerance": 7.4,
                "establishment_rate": 7.4,
                "mowing_tolerance": 8.6,
            },
            year="2020",
            seeding_rate="1-1.5 lbs/1000 sq ft",
            notes="High-density putting surface. Excellent mowing tolerance " "at ultra-low heights.",
        )
    )
    ...
    records.append(
        _add(
            ...
            "fairway_tee",
            {
                ...
                "density_score": 8.0,
                "disease_resistance": 7.2,
                "drought_tolerance": 8.8,
                "heat_tolerance": 8.5,
                "cold_tolerance": 6.5,
                "shade_tolerance": 5.0,
                "traffic_tolerance": 8.2,
                "establishment_rate": 7.5,
                "mowing_tolerance": 7.8,
            },
            year="2020",
            seed_available=0,
            seeding_rate="Vegetative only (sod/sprig)",
            notes="Outstanding drought tolerance -- uses 38% less water than Tifway 419. " "Vegetative cultivar.",
        )
    )
    records.append(
        _add(
            ...
            "fairway_tee",
            {
                ...
                "cold_tolerance": 7.8,
                "shade_tolerance": 4.5,
                "traffic_tolerance": 8.0,
                "establishment_rate": 7.8,
                "mowing_tolerance": 7.5,
            },
            year="2019",
            seed_available=0,
            seeding_rate="Vegetative only (sod/sprig)",
    ...
    records.append(
        _add(
            ...
            "fairway_tee",
            {
                ...
                "color_score": 7.3,
                "density_score": 7.6,
                "disease_resistance": 6.8,
                "drought_tolerance": 7.2,
                "heat_tolerance": 8.0,
                "cold_tolerance": 7.5,
                "shade_tolerance": 4.5,
                "traffic_tolerance": 7.8,
                "establishment_rate": 8.0,
                "mowing_tolerance": 7.3,
            },
            year="2019",
            seed_available=0,
            seeding_rate="Vegetative only (sod/sprig)",
            notes="Cold-hardy bermuda with early spring green-up. " "Fast establishment from sprigs.",
        )
    )
    records.append(
        _add(
            ...
            "fairway_tee",
            {
                ...
                "density_score": 8.0,
                "disease_resistance": 6.8,
                "drought_tolerance": 7.0,
                "heat_tolerance": 8.5,
                "cold_tolerance": 5.8,
                "shade_tolerance": 4.0,
                "traffic_tolerance": 8.5,
                "establishment_rate": 7.0,
                "mowing_tolerance": 8.0,
            },
            year="2018",
            seed_available=0,
            seeding_rate="Vegetative only (sod/sprig)",
            notes="Industry standard for bermuda fairways. " "Proven performer for decades. Dense, dark green turf.",
        )
    )
    records.append(
        _add(
            ...
            seed_available=0,
            seeding_rate="Vegetative only (sod/sprig)",
            notes="Dark blue-green color. Exceptional traffic recovery. " "Good shade tolerance for a bermuda.",
        )
    )
    records.append(
        _add(
            ...
            seed_available=0,
            seeding_rate="Vegetative only (sod/sprig)",
            notes="Fine-textured bermuda with rapid lateral growth. " "Excellent for tees and fairways.",
        )
    )
    ...
    records.append(
        _add(
            ...
            "lawn_turf",
            {
                ...
                "shade_tolerance": 5.5,
                "traffic_tolerance": 7.0,
                "establishment_rate": 5.5,
                "mowing_tolerance": 7.0,
            },
            year="2019",
            seeding_rate="2-3 lbs/1000 sq ft",
            notes="Top-rated KBG for overall quality. Excellent winter color " "and cold hardiness.",
        )
    )
    records.append(
        _add(
            ...
            "lawn_turf",
            {
                ...
                "density_score": 7.8,
                "disease_resistance": 7.5,
                "drought_tolerance": 6.8,
                "heat_tolerance": 6.2,
                "cold_tolerance": 8.2,
                "shade_tolerance": 6.0,
                "traffic_tolerance": 7.2,
                "establishment_rate": 5.8,
                "mowing_tolerance": 7.2,
            },
            year="2018",
            seeding_rate="2-3 lbs/1000 sq ft",
    ...
    records.append(
        _add(
            ...
            "lawn_turf",
            {
                ...
                "density_score": 8.0,
                "disease_resistance": 7.0,
                "drought_tolerance": 6.2,
                "heat_tolerance": 5.8,
                "cold_tolerance": 8.5,
                "shade_tolerance": 5.5,
                "traffic_tolerance": 7.5,
                "establishment_rate": 5.2,
                "mowing_tolerance": 7.5,
            },
            year="2019",
            seeding_rate="2-3 lbs/1000 sq ft",
    ...
    records.append(
        _add(
            ...
            "fairway_tee",
            {
                ...
                "shade_tolerance": 6.0,
                "traffic_tolerance": 7.8,
                "establishment_rate": 8.5,
                "mowing_tolerance": 7.5,
            },
            year="2020",
            seeding_rate="6-8 lbs/1000 sq ft",
            notes="Top-performing ryegrass for fairway use. " "Dark green color and fine texture.",
        )
    )
    records.append(
        _add(
            ...
            year="2020",
            seeding_rate="6-8 lbs/1000 sq ft",
            notes="Gray leaf spot resistant (3GL designation). " "Improved disease tolerance.",
        )
    )
    records.append(
        _add(
            ...
            "lawn_turf",
            {
                ...
                "shade_tolerance": 6.5,
                "traffic_tolerance": 7.2,
                "establishment_rate": 8.8,
                "mowing_tolerance": 7.0,
            },
            year="2019",
            seeding_rate="6-8 lbs/1000 sq ft",
            notes="Excellent home lawn variety. Fast establishment and good shade " "tolerance.",
        )
    )
    records.append(
        _add(
            ...
            year="2020",
            seeding_rate="6-8 lbs/1000 sq ft",
            notes="Sports turf specialist. Excellent wear tolerance and " "recovery. Gray leaf spot resistant.",
        )
    )
    # ----- Tall Fescue -----
    records.append(
    ...
    records.append(
        _add(
            ...
            year="2020",
            seeding_rate="6-8 lbs/1000 sq ft",
            notes="Lateral spreading tall fescue (2LS). Self-repairs thin areas. " "Good brown patch resistance.",
        )
    )
    records.append(
        _add(
            ...
            year="2019",
            seeding_rate="6-8 lbs/1000 sq ft",
            notes="Self-Repair Plus technology. Exceptional drought and heat " "tolerance. Fast establishment.",
        )
    )
    records.append(
        _add(
            ...
            year="2020",
            seeding_rate="6-8 lbs/1000 sq ft",
            notes="Developed for sports turf use. High traffic tolerance " "with good recovery.",
        )
    )
    ...
    records.append(
        _add(
            ...
            "lawn_turf",
            {
                ...
                "shade_tolerance": 6.5,
                "traffic_tolerance": 8.0,
                "establishment_rate": 5.0,
                "mowing_tolerance": 7.5,
            },
            year="2020",
            seed_available=0,
            seeding_rate="Vegetative only (sod/plug)",
    ...
    records.append(
        _add(
            ...
            seed_available=0,
            seeding_rate="Vegetative only (sod/plug)",
            notes="Best shade tolerance among zoysias. Good for " "partially shaded lawns in warm climates.",
        )
    )
    records.append(
        _add(
            ...
            year="2018",
            seeding_rate="1-2 lbs/1000 sq ft",
...
def recommend_cultivars(user_requirements):
    ...
    try:
        ...
        if not cultivars:
            return {
                "recommendations": [],
                "reasoning": "No cultivars matched the given requirements. " "Try broadening your search criteria.",
            }
        ...
        if top:
            reasoning_parts.append(
                f"Top recommendation: {top[0]['cultivar_name']} " f"(score {top[0]['recommendation_score']})."
            )

        return {
            "recommendations": scored[:10],
            "reasoning": " ".join(reasoning_parts) if reasoning_parts else "Ranked by overall NTEP quality score.",
...
def get_blend_recommendation(species, category=None, region=None):
    ...
    try:
        ...
        rationale_parts = [
            f"{pick1['cultivar_name']}: highest overall quality " f"(score {pick1.get('quality_score', 'N/A')}).",
        ...
        if pick3:
            rationale_parts.append(
                f"{pick3['cultivar_name']}: adds genetic diversity " f"(quality {pick3.get('quality_score', 'N/A')})."
            )
    ...
    try:
        ...
        if method == "seed" and not seed_available:
            return {
                ...
                "method": method,
                "error": f"{cultivar_name} is a vegetative-only cultivar. " f"Use sod, sprig, or plug instead.",
        ...
        try:
            ...
            total_str = f"{total_low}-{total_high} lbs" if total_low != total_high else f"{total_low} lbs"
...
def get_renovation_checklist(species, planting_method):
    ...
    if timeline:
        ...
        if best_planting:
            result["pre_planting"].insert(0, f"Schedule planting for optimal window: {best_planting}")
...
def delete_renovation_project(project_id, user_id):
    ...
    with get_db() as conn:
        conn.execute("DELETE FROM renovation_projects WHERE id = ? AND user_id = ?", (project_id, user_id))
    return {"deleted": True}
